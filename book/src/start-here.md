...
<div class="doc-path-grid">
  ...
  <a class="doc-path" href="operations-center.html"><span>Operate visually</span><strong>I want the Operations Center</strong><small>Inspect context, workloads, evidence, proposals, custody, Health, and Attention.</small></a>
...
Read [the governed workflow](workflow.md) for the responsibility of each stage, then use the [Operations Center](operations-center.md) for the current operational view. Before testing enforcement, check the [enforcement prerequisites](docs/enforcement-prerequisites.md): filesystem, network, and syscall policy depend on separate enforcement mechanisms.
