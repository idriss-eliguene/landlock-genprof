...
```bash
go install github.com/idriss-eliguene/landlock-genprof/cmd/landlock-genprof@v0.11.0

kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/rbac.yaml
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/crd-securityprofileproposal.yaml
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/rbac-proposal.yaml
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/rbac-patched-manifest.yaml
```
...
of any kind). Swap `@v0.11.0` for `@latest` to track the newest tag
...
```bash
go install -ldflags "-X main.version=v0.11.0" github.com/idriss-eliguene/landlock-genprof/cmd/landlock-genprof@v0.10.0
```
...
The published `v0.11.0` release currently has no binary assets. Do not invent
...
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/crd-traininghistory.yaml   # --history
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/rbac-history.yaml         # --history
kubectl apply -f https://raw.githubusercontent.com/idriss-eliguene/landlock-genprof/v0.11.0/deploy/rbac-restart.yaml        # --restart
```

Pinned to the `v0.11.0` tag rather than `master` on purpose — reproducible,
...
The `v0.11.0` chart is not verified as published during this review. Use the
...
The historical v0.11.0 installation path can optionally expose
