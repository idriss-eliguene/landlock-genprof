...
<nav class="panel" aria-label="Workbench sections"><strong>Observation Workbench</strong> · Overview · Observations · Proposals</nav><div class="panel" aria-label="Observation controls"><button id="start-observation" type="button">Start observation</button> <button id="stop-observation" type="button">Stop selected</button> <button id="generate-proposal" type="button">Generate proposal</button></div>
