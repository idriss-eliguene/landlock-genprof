...
func TestG7ClusterTemplatePrimaryNavigationAndContext(t *testing.T) {
	...
	for _, required := range []string{
		...
		"Proposals &amp; Governance", `id="refresh-operations-context"`, `id="cluster-selector"`, `id="identity-selector"`, `id="namespace-selector"`, `id="explicit-namespace-help"`, `class="environment-panel"`, `data-namespace="team-a"`, "<h2>Observations</h2>",
	} {
